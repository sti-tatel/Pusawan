...
public class Sell extends JPanel {
    ...
    public Sell() {
        ...
        arrowLeft.setBounds(20, 400, 100, 100);
        ...
        JButton trashBtn = new JButton(new ImageIcon(getClass().getResource("/images/trash.png")));
        trashBtn.setBounds(1210, 550, 140, 200);
        trashBtn.setBorderPainted(false);
        trashBtn.setContentAreaFilled(false);
        trashBtn.setFocusPainted(false);
        trashBtn.addActionListener(e -> Shop.toggleShop("trash"));
        bg.add(trashBtn);
