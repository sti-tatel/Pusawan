...
public class Fishing extends JPanel {
    ...
    class BackgroundPanel extends JPanel {
        ...
        void completeCatch() {
            ...
            if (!isJunk(lastCaughtFish)) {
                switch (lastCaughtFish) {
                    case "Perch":            PlayerData.addXP(8);  break;
                    case "Carp":             PlayerData.addXP(15); break;
                    case "Catfish":          PlayerData.addXP(25); break;
                    case "Bass":             PlayerData.addXP(40); break;
                    case "Sandal":           PlayerData.addXP(2);  break;
                    case "Shoe":             PlayerData.addXP(2);  break;
                    case "Plastic Wrapper":  PlayerData.addXP(1);  break;
                }
            }
        ...
        public void paintComponent(Graphics g) {
            ...
            if (fishingInProgress) {
                g.drawImage(fishingGif.getImage(), 0, 0, getWidth(), getHeight(), fishingInProgress ? null : this);
                drawMinigame(g);
            } else {
        ...
        if (PlayerData.equippedRod == null || PlayerData.equippedRod.equals("None")) {
            ...
            if ("Bamboo Rod".equals(PlayerData.equippedRod)) playerSize += 0.04f;
            if ("Hotdog Rod".equals(PlayerData.equippedRod)) playerSize += 0.08f;
            repaint();
        }
        ...
        private void drawXPBar(Graphics g) {
            ...
            String xpText = "Lv " + PlayerData.level + "  " + PlayerData.xp + "/" + PlayerData.xpToNextLevel;
            int xpTw = g2.getFontMetrics().stringWidth(xpText);
            g2.drawString(xpText, barX + (barW - xpTw) / 2, barY - 4);
        }
    }
}