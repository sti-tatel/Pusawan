...
public class Buttons extends JPanel {
    ...
    public static JButton toDropdown() {
        ...
        for (JButton b : new JButton[]{fishing, cutting, store}) {
    ...
    public static JButton toSettings() {
    Image img = new ImageIcon(Buttons.class.getResource("/images/settingsButton.png")).getImage().getScaledInstance(64, 64, Image.SCALE_SMOOTH);
    ...
    addClickSound(btn);
    btn.addActionListener(e -> Settings.toggleSettings());
    return btn;
    }
}